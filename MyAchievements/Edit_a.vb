Public Class Edit_a
	...
	Private Sub Edit_a_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub Save_Click(sender As Object, e As EventArgs) Handles Save.Click
		...
		Try
			My.Computer.FileSystem.DeleteFile(Achievementz.Get_dir & "\Ach\" & ini & "\z")
		Catch
		End Try
		My.Computer.FileSystem.DeleteDirectory(Achievementz.Get_dir & "\Ach\" & ini, FileIO.DeleteDirectoryOption.DeleteAllContents)
		...
		For Each control In Achievementz.FlowLayoutPanel1.Controls
			If DirectCast(control, Ubuntu_look_and_feel.TrophyIcon).BackColor = Color.DarkMagenta Then
				With DirectCast(control, Ubuntu_look_and_feel.TrophyIcon)
					.Name = Title.Text
